public class Main {
    public static void main(String[] args) {
        ...
        int miles = service.calculate(10000F);
        System.out.println(miles);

        int miles2 = service.calculate(10500.42F);
        System.out.println(miles2);

        int milesZero = service.calculate(0F);
        System.out.println(milesZero);

        int milesNegative = service.calculate(-10500.42F);
        System.out.println(milesNegative);

        int milesBig = service.calculate(10_500_000F);
